...
enum canvas_parts {BG, BORDER_RIGHT, BORDER_LEFT, BORDER_TOP, BORDER_BOTTOM, CORNER_TL, CORNER_TR, CORNER_BL, CORNER_BR};

// Locations and dimension for canvas sprites on the UI texture
